    ...
    <section ref={ref} className="relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 h-[600px] md:h-[700px]">
        {featuredPhotos.map((photo, i) => (
          ...
          >
            ...
            />
            {/* Dark gradient */}
            <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-ak-madera)]/80 via-[var(--color-ak-madera)]/20 to-transparent" />
          </motion.div>
        ))}
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        >
          ...
          <Link
            href="/reservar"
            className="inline-block bg-[var(--color-ak-borgona)] text-[var(--color-ak-cal)] px-12 py-5 rounded-full font-[family-name:var(--font-heading)] text-xl font-bold tracking-tight hover:bg-[var(--color-accent)] transition-all duration-300 active:scale-[0.97]"
          >
            Reservar Mesa
          </Link>
