  ...
  return (
    <div className="space-y-4">
        ...
        {summaryCards.map((card, index) => (
          ...
          >
            ...
            >
              ...
              <p className={`text-xl md:text-2xl font-bold ${card.color} font-[family-name:var(--font-heading)] mt-1`}>
      ...
      {zoneSummaries && zoneSummaries.length > 0 && (
        ...
        >
          <h3 className="text-sm font-semibold text-[var(--text-primary)] font-[family-name:var(--font-heading)] mb-3">
            Resumen por Zona
          </h3>
