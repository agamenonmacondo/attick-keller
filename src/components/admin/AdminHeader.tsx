...
export function AdminHeader() {
  ...
  return (
    <header className="sticky top-0 z-20 backdrop-blur-sm border-b border-[var(--border-default)]" style={{ backgroundColor: theme === 'dark' ? 'rgba(13,16,21,0.95)' : 'rgba(255,255,255,0.95)' }}>
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 h-14 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[10px] text-[#34495E] bg-[#F7F3E9] px-2 py-0.5 rounded font-medium uppercase tracking-wider dark:text-[#F4ECE4] dark:bg-[var(--color-ak-rust)]">Admin</span>
          <Link
            href="/host"
