...
>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[24px] bg-[var(--bg-primary)] dark:bg-[var(--bg-card)] p-2 no-underline shadow-sm transition-colors hover:bg-neutral-100 dark:hover:bg-[var(--bg-card)] ",
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-sm text-[var(--text-muted)] pb-2 px-1", className)}
    {...props}
  />
))
