      ...
      {blocks.map(block => (
        ...
        >
          ...
          <button
            ...
            className="text-[var(--color-ak-madera)]/40 dark:text-white/30 hover:text-[var(--color-danger)] dark:hover:text-[var(--color-danger)] transition-colors"
...
export function TableBlockForm({ date, tables, existingBlocks, onBlock, onClose, className }: TableBlockFormProps) {
  ...
  return (
    <div className={cn('space-y-3 p-4 rounded-lg border border-[var(--color-ak-madera)]/15 dark:border-[var(--border-light)]/10 bg-[var(--bg-card)]/50 dark:bg-[var(--bg-card)]/5', className)}>
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-2 py-1.5 text-sm rounded border border-[var(--color-ak-madera)]/20 dark:border-[var(--border-light)]/15 bg-[var(--bg-card)] dark:bg-[var(--bg-primary)] text-[var(--color-ak-madera)] dark:text-white"
          >
